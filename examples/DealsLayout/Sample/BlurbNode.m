...
- (CGSize)calculateSizeThatFits:(CGSize)constrainedSize
{
  ...
  CGSize measuredSize = [_textNode measure:CGSizeMake(MIN(0, constrainedSize.width - 2 * kTextPadding),
                                                      MIN(0, constrainedSize.height - 2 * kTextPadding))];
